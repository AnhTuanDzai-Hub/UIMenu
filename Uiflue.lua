...
local aa = {
    ...
    return {
        ...
        Accent             = Color3.fromRGB(255, 0, 0),     -- Đỏ
        TitleBarLine       = Color3.fromRGB(255, 127, 0),   -- Cam
        AcrylicBorder      = Color3.fromRGB(255, 255, 0),   -- Vàng
        Text               = Color3.fromRGB(0, 255, 0),     -- Lục

        -- ★ NỀN & KHUNG
        AcrylicMain        = Color3.fromRGB(40, 40, 40),
        AcrylicGradient    = ColorSequence.new(Color3.fromRGB(50, 50, 80),
                                               Color3.fromRGB(60, 50, 100)), -- lam + chàm
        AcrylicNoise       = 0.9,

        -- ★ TAB BÊN TRÁI
        Tab                = Color3.fromRGB(75, 0, 130),    -- Chàm

        -- ★ CÁC PHẦN TỬ
        Element            = Color3.fromRGB(148, 0, 211),   -- Tím
        ElementBorder      = Color3.fromRGB(90, 0, 130),
        InElementBorder    = Color3.fromRGB(255, 0, 0),     -- Đỏ
        ElementTransparency= 0.85,

        -- ★ TOGGLE
        ToggleSlider       = Color3.fromRGB(255, 165, 0),   -- Cam khi OFF
        ToggleToggled      = Color3.fromRGB(0, 255, 0),     -- Lục khi ON
        SliderRail         = Color3.fromRGB(0, 0, 255),     -- Lam

        -- ★ DROPDOWN
        DropdownFrame      = Color3.fromRGB(255, 255, 0),   -- Vàng
        DropdownHolder     = Color3.fromRGB(64, 64, 64),
        DropdownBorder     = Color3.fromRGB(138, 43, 226),  -- Tím xanh
        DropdownOption     = Color3.fromRGB(255, 0, 255),   -- Hồng tím

        -- ★ INPUT & KEYBIND
        Keybind            = Color3.fromRGB(75, 0, 130),    -- Chàm
        Input              = Color3.fromRGB(138, 43, 226),  -- Tím
        InputFocused       = Color3.fromRGB(25, 25, 60),
        InputIndicator     = Color3.fromRGB(0, 191, 255),   -- Light blue

        -- ★ HỘP THOẠI
        Dialog             = Color3.fromRGB(60, 60, 100),
        DialogHolder       = Color3.fromRGB(50, 50, 90),
        DialogHolderLine   = Color3.fromRGB(40, 40, 80),
        DialogButton       = Color3.fromRGB(255, 69, 0),    -- Cam đỏ
        DialogButtonBorder = Color3.fromRGB(255, 105, 180), -- Hồng
        DialogBorder       = Color3.fromRGB(153, 50, 204),  -- Purple
        DialogInput        = Color3.fromRGB(148, 0, 211),
        DialogInputLine    = Color3.fromRGB(255, 20, 147),  -- Deep Pink

        -- ★ VĂN BẢN PHỤ & HOVER
        SubText            = Color3.fromRGB(255, 255, 255), -- Trắng cho nổi bật
        Hover              = Color3.fromRGB(127, 255, 212), -- Aqua
        HoverChange        = 0.1,
    }
end,
    [51] = function()
